...
const MapCMS = lazy(() => import("./MapManagement"));
...
const AdminDashboard = () => {
  ...
  const [activeMapSubMenu, setActiveMapSubMenu] = useState("Tourist Spots");
  ...
  return (
    <div className="app-container">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (item === "Map Management")
                    setActiveMapSubMenu("Tourist Spots");
                }}
              >
                {item}
              </div>
                    ...
                    {[
                      ...
                      <div
                        ...
                        className={`submenu-item ${
                          activeContentSubMenu === subItem ? "active" : ""
                        }`}
                  ...
                  <div className="submenu-items">
                    {["Admins", "Users"].map((subItem) => (
                      <div
                        key={subItem}
                        className={`submenu-item ${
                          activeUserSubMenu === subItem ? "active" : ""
                        }`}
                ...
                <div className="submenu-items">
                  {["Tourist Spots", "Routing Settings"].map((subItem) => (
                    <div
                      key={subItem}
                      className={`submenu-item ${
                        activeMapSubMenu === subItem ? "active" : ""
                      }`}
      ...
      <main className="content">
        ...
        {activeMenu === "Visitor Logs" && (
          <Suspense fallback={<p>Loading Visitor Logs...</p>}>
            <VisitorLogs />
          </Suspense>
        )}

        {activeMenu === "Admin Logs" && (
          <Suspense fallback={<p>Loading Admin Logs...</p>}>
            <AdminLogs />
          </Suspense>
        )}
      </main>
